...
interface ISourceFormProps {
  ...
  onClose: () => void
  onTestSourceConnection: (config: object) => any
...
export class SourceForm extends React.PureComponent<ISourceFormProps & FormComponentProps> {
  ...
  private testSourceConnection = () => {
    ...
    this.props.onTestSourceConnection(config)
  }
      ...
      >
        <Form>
          <Row gutter={8}>
            ...
            <Col span={24}>
              <FormItem label="数据库类型" {...this.commonFormItemStyle}>
                {getFieldDecorator<ISource>('config.databaseType', {
                  initialValue: 'mysql'
                })(
                  <Select>
            ...
            <Col span={24}>
              <FormItem label="服务器地址" {...this.commonFormItemStyle}>
            ...
            <Col span={24}>
              <FormItem label="服务器端口" {...this.commonFormItemStyle}>
                {getFieldDecorator('config.port', {
                  ...
                  <Input autoComplete="off" placeholder="Port"/>
                )}
              </FormItem>
            </Col>
            <Col span={24}>
              <FormItem label="服务名" {...this.commonFormItemStyle}>
                {getFieldDecorator('config.sid', {
                  // rules: [{
                  //   required: true,
                  //   message: '服务名 不能为空'
                  // }],
                  ...
                  <Input autoComplete="off" placeholder="SID" />
                )}
              </FormItem>
            </Col>
            <Col span={24}>
